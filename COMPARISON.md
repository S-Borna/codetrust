...
| Statisk kodanalys | 802 regler | 5,000+ | 3,000+ | SAST | 800+ |
...
| **Svaghet** | 802 regler, intra-procedural taint (ej inter-proc) | Ingen AI governance, ingen paket/Docker-verifiering, kräver server |
...
| Behöver jag SonarQube om jag har CodeTrust? | **Ja, om du behöver djup SAST.** CodeTrust har 802 scan-regler, SonarQube 5,000+. |
...
*CodeTrust v3.0.0 — AI Governance Enforcement Platform. 802 rules + taint analysis, 27 MCP tools, 60 API endpoints, 2,058 tests.*
