...
> **Version 2.8.0 | Mars 2026 | Live på PyPI, VS Code Marketplace, Railway & GitHub**
...
**60 terminalregler** i 9 kategorier:
...
**Bevis:** Under byggandet av v2.8.0 försökte vår egen AI-agent skapa en fil med heredoc — gatewayen blockerade kommandot i realtid. Produkten skyddar sig själv.
...
|---|---|---|
| Realtids-blockering av AI-agentkommandon | **Ja** — 82 gateway-regler, pre-execution | **Nej** — ingen |
...
│  exekvering. 60 terminal + 20 content-regler.                    │
├──────────────────────────────────────────────────────────────────┤
...
| Metric | Värde |
|---|---|
| **Tester** | 1,937 (alla gröna) |
| **Testkörningstid** | ~4 sekunder |
| **Analysregler** | 286 (BLOCK/WARN/INFO) |
| **Språkstöd** | Python, JavaScript, TypeScript, Go, Rust, Java, C#, Ruby, PHP, C++, Shell, PowerShell, Terraform, HTML, SQL, Dockerfile, YAML |
...
| **Website** | **LIVE** | [`codetrust.ai`](https://codetrust.ai) |
...
8. **1,937 tester** — battle-tested, dogfooded under hela utvecklingen

### Där konkurrenterna vinner (ärligt)

1. **Regeldjup** — SonarQube har 5,000+ regler vs våra 286
2. **Språkbredd** — SonarQube 35+ språk, Semgrep 30+. Vi stöder 16
3. **SCA/CVE-scanning** — Snyk mappar dependencies mot kända sårbarheter. Vi har CVE-scanning via OSV men Snyk har djupare coverage
4. **Enterprise features** — SSO, RBAC, compliance finns nu i CodeTrust
5. **Taint analysis** — Semgrep gör cross-file dataflödesanalys. Vi gör regex + AST + signature validation
...
**Q: Vad är moat?**
First-mover i AI-kodverifiering med MCP-integration. 10 verifieringslager, 1937 tester, 5 distributionskanaler live. Teknisk skuld för konkurrenter att replikera.
...
*CodeTrust v2.8.0 — Built for the AI coding era. Live on PyPI, VS Code Marketplace & Railway.*
