...
<span class="fn">result</span> = <span class="fn">eval</span>(user_input)
<span class="str">API_KEY = "sk-abc123xyz"</span></span></pre>
      ...
      <div class="ctx-menu">
        ...
        <div class="ctx-item">
          <span class="ctx-icon">🔍</span>
          Search Google for "eval(user_input)"
        </div>
        <div class="ctx-item">
          <span class="ctx-icon">🔗</span>
          Open in new tab
  ...
  const screenshot4 = {
    ...
    <div class="page">
      ...
      <div class="popup">
        <div class="ph"><div class="pi">🛡️</div><div class="pt">CodeTrust</div><div class="pv">v2.7.0</div></div>
  ...
  const screenshot5 = {
    ...
    <div class="page">
      <div class="settings-card">
        <div class="sh">
          <div class="si">🛡️</div>
          <div><div class="stitle">CodeTrust Settings</div><div class="sv">v2.7.0 — AI Code Safety Scanner</div></div>
        </div>
        <div class="sbody">
