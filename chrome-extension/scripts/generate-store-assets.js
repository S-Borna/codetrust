...
<span class="str">API_KEY_HINT = "set-via-env"</span></span></pre>
  ...
  const screenshot4 = {
    ...
    <div class="page">
      ...
      <div class="popup">
        <div class="ph"><div class="pi">🛡️</div><div class="pt">CodeTrust</div><div class="pv">v2.8.1</div></div>
  ...
  const screenshot5 = {
    ...
    <div class="page">
      <div class="settings-card">
        <div class="sh">
          <div class="si">🛡️</div>
          <div><div class="stitle">CodeTrust Settings</div><div class="sv">v2.8.1 — AI Code Safety Scanner</div></div>
        </div>
        <div class="sbody">
