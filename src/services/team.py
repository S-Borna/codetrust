...
from sqlalchemy.ext.asyncio import AsyncSession, async_sessionmaker  # noqa: TC002 — used at runtime
...
class TeamRole(str, Enum):  # noqa: UP042 — StrEnum requires Python 3.11+
...
class TeamService:
    ...
    async def create_org(
        ...
        Args:
            ...
            owner_id: User ID of the creator (becomes owner).

        Returns:
            OrgInfo for the created organization.
        ...
        async with self._session_factory() as session:
            ...
            session.add(org)
            await session.flush()  # Ensure org.id is populated.
    ...
    async def add_member(
        ...
        Returns:
            MemberInfo if added, None if already a member.
        """
        try:
    ...
    async def update_org_policy(
        ...
        Args:
            ...
            policy: Dict of policy fields to update.
    ...
    def check_scan_against_policy(
        ...
        Args:
            policy: The organization's policy settings.
            verdict: Scan verdict ("PASS", "WARN", "BLOCK").
            critical_vulns: Number of critical vulnerabilities found.
            high_vulns: Number of high vulnerabilities found.
            license_risks: List of license risk types found.

        Returns:
            PolicyCheckResult indicating pass/fail and any violations.
        """
        violations: list[str] = []
        ...
        if policy.require_license_compliance and license_risks:
